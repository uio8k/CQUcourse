...
def main():
    ...
    st.markdown("""
    ### 💡 使用建议
    1. **求职者**：通过薪资分析和技能洞察，了解市场行情，规划职业发展
    2. **应届生**：重点关注"经验不限"和"在校/应届"职位，以及技能需求
    3. **转行者**：关注技能要求相对宽松的职位，以及提供培训机会的公司
    4. **HR/招聘者**：参考薪资水平和技能需求，制定合理的招聘策略
